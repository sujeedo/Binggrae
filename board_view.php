...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./css/board_view3.css">
    ...
    <body>
        ...
        <section>
            <h1>자유게시판</h1>
                <div id="main_img"><img src="image/freeboard.png" alt="bg"></div>
                <div id="board_box">
                    ...
                    <?php
                        ...
                        $new_hit=$hit+1;
                        $sql="update board set hit=$new_hit where num=$num";// 조회수
                    ...
                    <ul class="buttons">
                        ...
                        <li>
                            <?php 
                                ...
                                ?>
                                    <a href="javascript:alert('로그인 후 이용해 주세요!')"><button>수정</button></a>
                                <?php
                                    }
                                ?>
