...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./css/event_board_form3.css">
        ...
        <script>
            function check_input() {
                if (!document.event_board_form.esubject.value)
                {
                    alert("제목을 입력하세요!");
                    document.event_board_form.esubject.focus();
                    return;
                }
                if (!document.event_board_form.imgname.value)
                {
                    alert("이미지를 올려주세요!");
                    document.event_board_form.imgname.focus();
                    return;
                }
                document.event_board_form.submit();
            }
        </script>
    ...
    <body>
        ...
        <section>
            <h1>이벤트</h1>
            <div id="main_img">
                <img src="image/eventbg.png" alt="bg">
            </div>  
            <div id="board_box">
                <h3 id="board_title">
                    EVENT >> 참여하기
                </h3>
                <form  name="event_board_form" method="post" action="event_board_insert1.php" enctype="multipart/form-data">
                    <table>
                        <tr>
                            <th>
                                이름(ID) 
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="subj" class="sub" name="esubject" type="text" style="border:none;" placeholder="~사진과 어울리는 제목을 남겨주세요~(최대 30글자)" maxlength="30">
                            </td>
                        </tr>
                        <tr>
                            <th>
                    ...
                    <div class="buttons">
                        ...
                        <button class="btn" type="button" onclick="check_input();">업로드</button>
                        <button class="btn" type="button" onclick="location.href='event_board.php'">목 록</button>
                    </div>
                </form>
            </div>
        </section>
