                ...
                <form  name="board_form" method="post" action="board_insert.php" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="chk_length" name="subject" type="text" style="border:none;" maxlength="20">
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <textarea class="chk_length" name="content" style="border:1px solid white" maxlength="1000"></textarea>
                            </td>
                        </tr>
                    </table>
                    <script>
                    ...
                    <div class="buttons">
                        <button type="button" onclick="check_input()">작성 완료</button>
                        <button type="button" onclick="location.href='board_list.php'">목 록</button>
                    </div>
                </form>
            </div> <!-- board_box -->
        </section>
